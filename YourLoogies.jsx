...
function YourLoogies({
  ...
  const loogiesLeft = 25 - totalSupply;
    ...
    <>
      <div style={{ maxWidth: 820, margin: "auto", marginTop: 32, paddingBottom: 32 }}>
        <div style={{ fontSize: 16 }}>
          <p>
                  <img src="https://i.postimg.cc/HnTkHgyK/skulltransparent.jpg" height={400}></img>

                  <br></br>

            There are<strong> 25 Skulls</strong> available on a price curve <strong>increasing 5%</strong> with
            each new mint.
          </p>
          <p>The Skull NFTs are SVG representations of the original art work above that was created for this building exercise.</p>
                    <p>The illustrations herein are meant to be a celebration of change, transformation and continuity of life.</p> 
